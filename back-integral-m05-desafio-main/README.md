...
**Repositório de Backend**: https://github.com/brunobarbosa17/back-integral-m05-desafio 

**Repositório de Frontend**: https://github.com/brunobarbosa17/front-integral-m05-desafio

**URL da aplicação funcionando**: https://projeto-final-cubos.herokuapp.com/

---

E os itens abaixo, que deverão ser preenchidos apenas após a finalização de todas as sprints do projeto: 

**Pull Request (PR) de Backend**: https://github.com/cubos-academy/back-integral-m05-desafio/pull/27

**Pull Request (PR) de Frontend**: https://github.com/cubos-academy/front-integral-m05-desafio/pull/45
